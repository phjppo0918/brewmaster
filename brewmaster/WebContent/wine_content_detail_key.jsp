  ...
  <div id="body">
    ...
    <%
		    ...
		    Connection conn = ConnectionProvider.getConnection();
				try{
					...
					view = dao.getProductListNatWKey(conn, pageNumber, nation_kr, target);
	...
	%>
     ...
     <div id="product_content_header2">
 	   <img src="images/wine_hbeer_contents_images/<%=nation%>_title.png" width="170" height="45" />
   ...
   <% for (int i = 1 ; i <= view.getPageTotalCount() ; i++) { %>
					  <a href="wine_content_detail_key.jsp?target=<%=target %>&nation=<%=nation %>&page=<%= i %>">[<%= i %>]</a> 
					<% } %>
   </div><!--paging -->
