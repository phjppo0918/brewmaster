...
<title>무제 문서</title>
<link href="css_all/worldbeer_contents.css?var=1" rel="stylesheet" type="text/css" />
...
<div id="worldbeer_content_wrap">
   ...
   <%
		    ...
		    Connection conn = ConnectionProvider.getConnection();
				try{
					...
					view = dao.getProductListShAll(conn, pageNumber, target);
		   		}catch(SQLException e){}
	%>
  <div id="worldbeer_content_header2">
    <img src="images/worldbeer_contents_images/all_view_title.png" width="170" height="45"/>
      ...
      <div id="worldbeer_image">
       ...
       ${product.p_name_en}
        ...
        <div id="worldbeer_action"> 
          <a href="#"><img src="images/worldbeer_contents_images/purchase_now_btn.png" width="45" height="20"/></a>
  ...
  <div id="paging">
	<% for (int i = 1 ; i <= view.getPageTotalCount() ; i++) { %>
					  <a href="worldbeer_contents_key.jsp?target=<%=target %>&page=<%= i %>">[<%= i %>]</a> 
					<% } %>
  </div><!--paging -->
