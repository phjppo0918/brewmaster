...
<div id="error_page">
  <div id="error404">
    <div id="error404_img"><img src="images/error_page_images/error500.png" width="500" height="500" /></div><!--error_404_img -->
  </div><!--error404 -->
  <div id="main_btn">
    <div id="main_btn_img"><img src="images/error_page_images/mainpage_btn.png" width="100" height="40" 
    onclick="location.href='main.jsp'"/></div><!--main_btn_img -->
  </div><!--main_btn -->
</div><!--error_page -->
</body>
</html>
