...
<title>무제 문서</title>
<link href="css_all/wine_detail.css" rel="stylesheet" type="text/css" />
...
#cart_button {
	...
	margin-top: 10px;
	background-image: url(images/wine_detail_images/cart_btn.png);
}
#side_bagIn{
	width: 200px;
	position: fixed;
...
#purchase_button {
	...
	background-size: contain;
	margin-top: 10px;
	background-image: url(images/wine_detail_images/direct_buy_btn.png);
	margin-left: 10px;
}
#mywish_button{
	width:50px;
	...
	background-repeat: no-repeat;
	background-size: contain;
	background-image: url(images/wine_detail_images/mywish_btn.png);
	line-height: 1px;
}
</style>
...
<div id="wrap">
  ...
  <div id="body">
	<div id="wine_detail_wrap">
	  <div id="wine_detail_header">
	 ...
	 </div><!--wine_detail_main -->
   </div><!--wine_detail_wrap -->
