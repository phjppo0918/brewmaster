...
<link href="css_all/searchPWStyle.css" rel="stylesheet" type="text/css" />
  ...
  <div id="body">
	<div class="login_main">
    	...
    	<div class="login_input">
      		<form action="process/searchPwProcess.jsp" method="post" onsubmit="return ck_sub();">
      		  <input name="u_id" id="u_id" type="text"placeholder="아이디" />
      		  <p></p>
      		  ...
      		  <p></p>
       		  ...
       		  <p></p>
       		  <p>
         		<input name="search_pw_button" type="submit"  id="search_pw_button" value="비밀번호 찾기"/> 
       		  </p>
      	 	</form>
    	</div><!-- login_input-->
