...
<div id="wrap">
  ...
  <%
  	...
  	try{
		...
		hb = pdao.selectById(conn, h_beer_no);
		
		if(u_coin<(hb.getH_beer_price()*amount)){
  ...
  %>
  <form action="process/orderHBProcess.jsp" method="post"><%-- form위치ㅐ!! --%>
  <div id="body">
            ...
            <tr>   <%--foreach문 시작 --%>
        	  <td>
                <div id="product_image">
            	   <img src="images/h_beer_images_user/<%=hb.getH_beer_image() %>" width="70" height="126"/>
                </div><!--product_image -->
              </td>
              <td width="172"><%=hb.getH_beer_name() %></td>
              <td><%=hb.getH_beer_price() %></td>
              <td><%=amount %></td>
              <td><%=hb.getH_beer_price()*amount %></td>
            </tr>			<%--foreach문 끝 --%>
	...
	<div id="order_purchase_main3">
	  ...
	  <div id="o_purchase_main3_main">
        <table id="table3">
    	  ...
    	  <td width="541"><%=hb.getH_beer_price()*amount %> 코인</td>
  	    </tr>
  	    <tr>
    	  ...
    	  <td><%=u_coin-hb.getH_beer_price()*amount  %>코인</td>
  	    </tr>
	  </table>
  ...
  <div id="purchase_button">
  	...
  	<input type="hidden" name="h_beer_no" value="<%=hb.getH_beer_no() %>"/>
  	<input type="hidden" name="total_coin" value="<%=hb.getH_beer_price()*amount %>"/>
  	<input type="hidden" name="u_coin" value="<%=u_coin-hb.getH_beer_price()*amount  %>"/>
